...
public class MoonChunkGenerator extends ChunkGenerator<MoonGenerationSettings> {
    ...
    public MoonChunkGenerator(IWorld worldIn, MoonBiomeProvider biomeProviderIn, MoonGenerationSettings settingsIn) {
    ...
    public int func_222529_a(int p_222529_1_, int p_222529_2_, Heightmap.Type heightmapType) {
        ...
        for(int j1 = this.noiseSizeY - 1; j1 >= 0; --j1) {
            ...
            for(int k1 = this.verticalNoiseGranularity - 1; k1 >= 0; --k1) {
                ...
                if (d11 > 0.0D || l1 < i1) {
                    if (heightmapType.getHeightLimitPredicate().test(this.defaultBlock)) {
                        return l1 + 1;
                    }
                }
            }
    ...
    protected void makeBedrock(IChunk chunkIn, Random rand) {
        ...
        MoonGenerationSettings t = this.getSettings();
